...
Description: replaces words with a filter word
Version:1.0
Author: kalyani
...
*/
 ...
 class ourwordfilterplugin{
  ...
  function ourSettings(){
	  ...
	  add_settings_field('replacement-text-Filter','Filtered Text',array($this,'replacementFieldHTML'),'word-filter-options','replacement-text-section');
 ...
 function ourmenu(){
	...
	//add_options_page('Words To Filters','Words Filter', 'manage_options', 'ourwordfilter', array($this, 'wordFilterPage'), 'dashicons-smiley', 100);
	  ...
	  add_submenu_page('ourwordfilter','Words To Filter', 'Word Filter List', 'manage_options', 'ourwordfilter', array($this, 'wordFilterPage'));
  ...
  function mainPageAssets(){
	   ...
	   wp_enqueue_style('wordfilterstyle',plugin_dir_url(__FILE__).'styles.css');
  }
